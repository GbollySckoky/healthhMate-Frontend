                ...
                {notifications.map((notification, index) => (
                    <div className="flex items-center justify-between py-3" key={index}>
                        ...
                        <span> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#000000" fill="none">
                            ...
                            <path d="M16 6H8C4.68629 6 2 8.68629 2 12C2 15.3137 4.68629 18 8 18H16C19.3137 18 22 15.3137 22 12C22 8.68629 19.3137 6 16 6Z" stroke="currentColor" strokeWidth="1.5"></path></svg>
                        </span>
                    </div>
                ))}
            </div>
